    ...
    : RecyclerView.Adapter<CharacterAdapter.CharacterHolder>()
{
    ...
    override fun onBindViewHolder(holder: CharacterHolder, position: Int) {
        ...
        /*for (title in list[position].titles) titlesString+=title;
        var aliasesString : String = "";
        for (title in list[position].aliases) aliasesString+=title;
        var actorsString : String = "";
        for (title in list[position].playedBy) actorsString+=title;*/
